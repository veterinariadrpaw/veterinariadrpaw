...
export default function OperationsAnalyticsPage() {
    ...
    const [appointmentChartType, setAppointmentChartType] = useState<typeof chartTypes[number]>(() =>
        getInitialChartType("appointmentChartType", "pie")
    );
    ...
    useEffect(() => { localStorage.setItem("appointmentChartType", appointmentChartType); }, [appointmentChartType]);
